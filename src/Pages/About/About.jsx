...
const About = () => {
    return (
        <div>
            <section className="bg-gradient-to-r from-[#FF7594] via-[#FF797B] to-[#FF7C65] min-h-screen dark:bg-gray-900">
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-gray-200 capitalize lg:text-3xl dark:text-gray-100">explore our <br /> awesome Components</h1>
        ...
        <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
            <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                <div className="space-y-3">
                    <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-xl dark:text-gray-100 dark:bg-blue-500">
