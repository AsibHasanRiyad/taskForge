...
const Dashboard = () => {
  ...
  return (
    <div className=" my-6 lg:my-20 px-4 lg:px-10 bg-gradient-to-r from-[#FF7594] via-[#FF797B] to-[#FF7C65] rounded-md ">
        <h1 className=" text-center font-semibold text-4xl py-6">Task<span className=" text-gray-100">Bar</span></h1>
      ...
      <h1 className=" text-center text-gray-300 pb-2">Click over the title to see task details</h1>
    </div>
  );
};
